  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cream-100 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-cream-50 border border-blush-100 rounded-3xl shadow-sm p-7">
          {status === 'sent' ? (
            <div className="text-center py-2">
              <div className="mx-auto w-11 h-11 rounded-full bg-blush-100 flex items-center justify-center mb-4">
                <Mail size={20} className="text-blush-500" strokeWidth={1.75} />
              </div>
